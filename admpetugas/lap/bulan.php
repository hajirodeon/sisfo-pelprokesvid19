...
//hapus dulu yg ada
mysqli_query($koneksi, "DELETE FROM lap_bulan ".
...
for ($k=1;$k<=12;$k++)
	...
	//insert
	$xyz = "$x$k";
	mysqli_query($koneksi, "INSERT INTO lap_bulan(kd, tahun, bulan, jml, postdate) VALUES ".
								"('$xyz', '$tahunnya', '$k', '$tyuk', '$today')"); 		
	}
//PROSES PENGUMPULAN NILAI DULU ///////////////////////////////////////////////////////////////////////
...
//tampilkan
$qku = mysqli_query($koneksi, "SELECT * FROM lap_bulan ".
								"ORDER by round(bulan) ASC");
...
do 
	...
	echo '<div class="progress-group">
		<span class="progress-text">'.$arrbln[$i_nama].' '.$i_tahun.'</span>
